...
%
% There are numerous MATLAB functions that default to operate along the first
% non-singleton dimension. This function is useful for finding this default
% dimension.
%
% See also:
%   SIZE NDIMS.
