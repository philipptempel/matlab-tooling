...
for js = 1:numstrings
    ...
    for iu = 1:length(units)
        ...
        if amount > 0
            ...
            if amount > 1
                string = [string, num2str(amount), ' ', plurals{iu}];%#ok
            else
                string = [string, num2str(amount), ' ', singles{iu}];%#ok
            end
